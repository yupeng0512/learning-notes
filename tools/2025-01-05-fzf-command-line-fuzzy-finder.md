...
- [fzf 官方 GitHub](https://github.com/junegunn/fzf) - 项目源码
- [fzf 官方文档](https://junegunn.github.io/fzf/) - 完整文档
- [fzf Wiki 示例集](https://github.com/junegunn/fzf/wiki/Examples) - 社区示例
- [fd GitHub](https://github.com/sharkdp/fd) - 更快的 find 替代品
- [ripgrep GitHub](https://github.com/BurntSushi/ripgrep) - 更快的 grep 替代品
- [bat GitHub](https://github.com/sharkdp/bat) - 带语法高亮的 cat
